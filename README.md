...
<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Inicial.png">  <br/>
### Tela de Login:

<img width="500" height="340" src="./img/prototiposTela/TelaP_Login.png">  <br/>
### Tela de Cadastro Brechó:
### Etapa Um:

<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Brecho_E1.png">  <br/>

### Etapa Dois:

<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Brecho_E2.png">  <br/>

### Etapa Três:

<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Brecho_E3.png">  <br/>

### Tela Cadastro Cliente:
### Etapa Um: 
<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Cliente_E1.png">  <br/>

### Etapa Dois: 

<img width="500" height="340" src="./img/prototiposTela/TelaP_Cadastro_Cliente_E2.png">  <br/>

### Etapa Três:

<img width="500" height="340" src="/img/prototiposTela/TelaP_Cadastro_Cliente_E3.png">  <br/>
