...
import Pop_up_notificacao_comprado from '../../components/sacola/Pop_up_notificacao_comprado';
...
function Sacola_geral() {
  ...
  async function diminuir_quantia_selecionada(produto_selecionado) {
    if (produto_selecionado.quantidade_selecionada <= 1) return; // Previne quantidade menor que 1
  ...
  async function aumentar_quantidade_selecionada(produto_selecionado) {
    if (produto_selecionado.quantidade_selecionada >= produto_selecionado.quantidade) return; // Previne ultrapassar estoque
  ...
  async function finalizarCompra() {
    try {
      ...
      // Opcional: log para conferir o que está sendo enviado
      console.log("Enviando sacola para checkout:", sacola);
