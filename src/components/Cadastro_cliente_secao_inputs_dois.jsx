...
function Cadastro_cliente_secao_inputs_dois() {
  ...
  return (
    <div className='container_inputs_secao_um_e_dois'>
        ...
        <input type="text" placeholder='(DD) 99123-4567' min={14} maxLength={14} required value={form_de_cadastro_cliente.telefone} onChange={e => set_form_de_cadastro_cliente({...form_de_cadastro_cliente, telefone: e.target.value})}/>

        <label>CPF<span>*</span></label>
        <input type="text" placeholder='000.000.000-00' min={14} maxLength={14} value={form_de_cadastro_cliente.cpf} onChange={e => set_form_de_cadastro_cliente({...form_de_cadastro_cliente, cpf: e.target.value})}/>
