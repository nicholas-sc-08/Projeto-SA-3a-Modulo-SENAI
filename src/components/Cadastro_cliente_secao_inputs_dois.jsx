...
function Cadastro_cliente_secao_inputs_dois() {
  ...
  return (
    <div className='container_inputs_secao_um_e_dois'>
        ...
        <input type="text" placeholder='(DDD) 99123-4567' required value={form_de_cadastro_cliente.telefone} onChange={e => set_form_de_cadastro_cliente({...form_de_cadastro_cliente, telefone: e.target.value})}/>
